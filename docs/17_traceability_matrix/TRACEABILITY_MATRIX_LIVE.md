...
|---|---|---|---|---|
| `<pending-cp960b>` | 2026-05-18 17:15 BST | **CP9.60b** | LIVE doc SHA sweep | Replace `<pending>` placeholders for CP9.52/9.53/9.55/9.56/9.57/9.58/9.59 with the actual landed SHAs (1b8a2f5, aefb18c, 321ceb7). LIVE matrix now grounded against `origin/main` HEAD. Per Rule A.11: this row is documentation reconciliation, not a code CP. |
